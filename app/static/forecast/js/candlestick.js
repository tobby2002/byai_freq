...
var dom = document.getElementById("candlestic_id");
    ...
    $.ajax({
        ...
        success: function(results){
            ...
            if (this_time !== last_time) {
                ...
                option.series[0].data.push(t_ohlc.values[0]);  // option.series[0].data.push([2360.75,2382.48,2347.89,2383.76]);

                // ma5
                // option.series[1].data.shift();
                // option.series[1].data.push(calculateMA_add(5, t_ohlc));  // console.log('calculateMA(5, t_ohlc):' + (calculateMA_add(5, t_ohlc)).toString());
                //
                // // ma20
                // option.series[2].data.shift();
                // option.series[2].data.push(calculateMA_add(20, t_ohlc));
