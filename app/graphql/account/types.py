...
class CustomerEvent(CountableDjangoObjectType):
    ...
    order = gql_optimizer.field(
        graphene.Field(
            "app.graphql.order.types.Order", description="The concerned order."
        ),
        model_field="order",
    )
    order_line = graphene.Field(
        "app.graphql.order.types.OrderLine", description="The concerned order line."
    )
...
class User(MetadataObjectType, CountableDjangoObjectType):
    ...
    gift_cards = gql_optimizer.field(
        PrefetchingConnectionField(
            "app.graphql.giftcard.types.GiftCard",
    ...
    orders = gql_optimizer.field(
        PrefetchingConnectionField(
            "app.graphql.order.types.Order", description="List of user's orders."
        ),
        model_field="orders",
    )
    ...
    stored_payment_sources = graphene.List(
        "app.graphql.payment.types.PaymentSource",
