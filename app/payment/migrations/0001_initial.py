            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            (
                                app.payment.TransactionError("incorrect_number"),
                                "incorrect_number",
                            ),
                            (
                                app.payment.TransactionError("invalid_number"),
                                "invalid_number",
                            ),
                            (
                                app.payment.TransactionError("incorrect_cvv"),
                                "incorrect_cvv",
                            ),
                            (
                                app.payment.TransactionError("invalid_cvv"),
                                "invalid_cvv",
                            ),
                            (
                                app.payment.TransactionError("incorrect_zip"),
                                "incorrect_zip",
                            ),
                            (
                                app.payment.TransactionError("incorrect_address"),
                                "incorrect_address",
                            ),
                            (
                                app.payment.TransactionError("invalid_expiry_date"),
                                "invalid_expiry_date",
                            ),
                            (app.payment.TransactionError("expired"), "expired"),
                            (
                                app.payment.TransactionError("processing_error"),
                                "processing_error",
                            ),
                            (app.payment.TransactionError("declined"), "declined"),
                        ],
                        max_length=256,
                        null=True,
                    ),
