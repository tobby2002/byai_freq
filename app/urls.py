...
from .tradingroom.urls import urlpatterns as tradingroom_urls
...
handler404 = "app.core.views.handle_404"

non_translatable_urlpatterns = [
    url(r"^dashboard/", include((dashboard_urls, "dashboard"), namespace="dashboard")),
    url(r"^tradingroom/", include((tradingroom_urls, "tradingroom"), namespace="tradingroom")),
    url(r"^manager/", include((manager_urls, "manager"), namespace="manager")),
