...
@register.inclusion_tag("tradingroom/product/product_variant/_image_select.html")
def render_image_choice(field):
    choices = zip(field, field.field.queryset)
    return {"field": field, "choices_with_images": choices}


@register.inclusion_tag("tradingroom/includes/_pagination.html", takes_context=True)
...
@register.inclusion_tag("tradingroom/includes/_filters.html", takes_context=True)
...
@register.inclusion_tag("tradingroom/includes/_sorting_header.html", takes_context=True)
