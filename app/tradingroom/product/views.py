...
def product_list(request):
    ...
    return TemplateResponse(request, "tradingroom/product/list.html", ctx)
...
def product_details(request, pk):
    ...
    return TemplateResponse(request, "tradingroom/product/detail.html", ctx)
...
def product_select_type(request):
    ...
    if form.is_valid():
        ...
        status = 400
    ctx = {"form": form}
    template = "tradingroom/product/modal/select_type.html"
...
def product_create(request, type_pk):
    ...
    if product_form.is_valid() and not variant_errors:
        ...
        return redirect("tradingroom:product-details", pk=product.pk)
    ctx = {
        "product_form": product_form,
        "variant_form": variant_form,
        "product": product,
    }
    return TemplateResponse(request, "tradingroom/product/form.html", ctx)
...
@permission_required("product.manage_products")
def product_candlestick(request, pk):
    product = get_object_or_404(
        Product.objects.prefetch_related("variants", "product_type__attributeproduct"),
        pk=pk,
    )
    ...
    if form.is_valid() and not variant_errors:
        ...
        return redirect("tradingroom:product-details", pk=product.pk)
    ctx = {"product": product, "product_form": form, "variant_form": variant_form}
    return TemplateResponse(request, "tradingroom/product/candlestick.html", ctx)

@permission_required("product.manage_products")
def product_showpredict(request, pk):
    product = get_object_or_404(
        Product.objects.prefetch_related("variants", "product_type__attributeproduct"),
        pk=pk,
    )
    ...
    if form.is_valid() and not variant_errors:
        ...
        return redirect("tradingroom:product-details", pk=product.pk)
    ctx = {"product": product, "product_form": form, "variant_form": variant_form}
    return TemplateResponse(request, "tradingroom/product/showpredict.html", ctx)
...
def product_delete(request, pk):
    ...
    if request.method == "POST":
        ...
        messages.success(request, msg)
        return redirect("tradingroom:product-list")
    return TemplateResponse(
        request, "tradingroom/product/modal/confirm_delete.html", {"product": product}
    )
...
def product_type_list(request):
    ...
    return TemplateResponse(request, "tradingroom/product/product_type/list.html", ctx)
...
def product_type_create(request):
    ...
    if form.is_valid():
        ...
        messages.success(request, msg)
        return redirect("tradingroom:product-type-list")
    ctx = {"form": form, "product_type": product_type}
    return TemplateResponse(request, "tradingroom/product/product_type/form.html", ctx)
...
def product_type_edit(request, pk):
    ...
    if form.is_valid():
        ...
        messages.success(request, msg)
        return redirect("tradingroom:product-type-update", pk=pk)
    ctx = {"form": form, "product_type": product_type}
    return TemplateResponse(request, "tradingroom/product/product_type/form.html", ctx)
...
def product_type_delete(request, pk):
    ...
    return TemplateResponse(
        request, "tradingroom/product/product_type/modal/confirm_delete.html", ctx
    )
...
def variant_details(request, product_pk, variant_pk):
    ...
    return TemplateResponse(
        request, "tradingroom/product/product_variant/detail.html", ctx
    )
...
def variant_create(request, product_pk):
    ...
    if form.is_valid():
        ...
        messages.success(request, msg)
        return redirect(
            "tradingroom:variant-details", product_pk=product.pk, variant_pk=variant.pk
        )
    ctx = {"form": form, "product": product, "variant": variant}
    return TemplateResponse(request, "tradingroom/product/product_variant/form.html", ctx)
...
def variant_delete(request, product_pk, variant_pk):
    ...
    return TemplateResponse(
        request, "tradingroom/product/product_variant/modal/confirm_delete.html", ctx
    )
...
def variant_images(request, product_pk, variant_pk):
    ...
    ctx = {"form": form, "product": product, "variant": variant}
    return TemplateResponse(
        request, "tradingroom/product/product_variant/modal/select_images.html", ctx
    )
...
def product_images(request, product_pk):
    ...
    return TemplateResponse(request, "tradingroom/product/product_image/list.html", ctx)
...
def product_image_create(request, product_pk):
    ...
    if form.is_valid():
        ...
        messages.success(request, msg)
        return redirect("tradingroom:product-image-list", product_pk=product.pk)
    ctx = {"form": form, "product": product, "product_image": product_image}
    return TemplateResponse(request, "tradingroom/product/product_image/form.html", ctx)
...
def product_image_delete(request, product_pk, img_pk):
    ...
    return TemplateResponse(
        request,
        "tradingroom/product/product_image/modal/confirm_delete.html",
...
def attribute_list(request):
    ...
    return TemplateResponse(request, "tradingroom/product/attribute/list.html", ctx)
...
def attribute_details(request, pk):
    ...
    return TemplateResponse(request, "tradingroom/product/attribute/detail.html", ctx)
...
def attribute_create(request):
    ...
    if form.is_valid():
        ...
        messages.success(request, msg)
        return redirect("tradingroom:attribute-details", pk=attribute.pk)
    ctx = {"attribute": attribute, "form": form}
    return TemplateResponse(request, "tradingroom/product/attribute/form.html", ctx)
...
def attribute_delete(request, pk):
    ...
    if request.method == "POST":
        ...
        messages.success(request, msg)
        return redirect("tradingroom:attributes")
    return TemplateResponse(
        request,
        "tradingroom/product/attribute/modal/" "attribute_confirm_delete.html",
        {"attribute": attribute},
    )
...
def attribute_value_create(request, attribute_pk):
    ...
    if form.is_valid():
        ...
        messages.success(request, msg)
        return redirect("tradingroom:attribute-details", pk=attribute_pk)
    ctx = {"attribute": attribute, "value": value, "form": form}
    return TemplateResponse(
        request, "tradingroom/product/attribute/values/form.html", ctx
    )
...
def attribute_value_delete(request, attribute_pk, value_pk):
    ...
    return TemplateResponse(
        request,
        "tradingroom/product/attribute/values/modal/confirm_delete.html",
