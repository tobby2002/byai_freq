...
urlpatterns = [
    ...
    url(r"^(?P<pk>[0-9]+)/candlestick/$", views.product_candlestick, name="product-candlestick"),
    url(r"^(?P<pk>[0-9]+)/showpredict/$", views.product_showpredict, name="product-showpredict"),
