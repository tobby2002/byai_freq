...
class OrderCustomerForm(forms.ModelForm):
    ...
    user = AjaxSelect2ChoiceField(
        ...
        fetch_data_url=reverse_lazy("tradingroom:ajax-users-list"),
        required=False,
        label=pgettext_lazy(
...
class OrderShippingForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        fetch_data_url = reverse(
            "tradingroom:ajax-order-shipping-methods",
...
class OrderEditVoucherForm(forms.ModelForm):
    ...
    voucher = AjaxSelect2ChoiceField(
        ...
        fetch_data_url=reverse_lazy("tradingroom:ajax-vouchers"),
        min_input=0,
...
class AddVariantToOrderForm(forms.Form):
    ...
    variant = AjaxSelect2ChoiceField(
        ...
        fetch_data_url=reverse_lazy("tradingroom:ajax-available-variants"),
        label=pgettext_lazy(
