...
def order_list(request):
    ...
    return TemplateResponse(request, "tradingroom/order/list.html", ctx)
...
def create_order_from_draft(request, order_pk):
    ...
    if form.is_valid():
        ...
        status = 400
    template = "tradingroom/order/modal/create_order.html"
...
def remove_draft_order(request, order_pk):
    ...
    if request.method == "POST":
        ...
        messages.success(request, msg)
        return redirect("tradingroom:orders")
    template = "tradingroom/order/modal/remove_order.html"
    ctx = {"order": order}
...
def order_details(request, order_pk):
    ...
    return TemplateResponse(request, "tradingroom/order/detail.html", ctx)
...
def order_add_note(request, order_pk):
    ...
    template = "tradingroom/order/modal/add_note.html"
    return TemplateResponse(request, template, ctx, status=status)
...
def capture_payment(request, order_pk, payment_pk):
    ...
    return TemplateResponse(
        request, "tradingroom/order/modal/capture.html", ctx, status=status
    )
...
def refund_payment(request, order_pk, payment_pk):
    ...
    return TemplateResponse(
        request, "tradingroom/order/modal/refund.html", ctx, status=status
    )
...
def void_payment(request, order_pk, payment_pk):
    ...
    return TemplateResponse(
        request, "tradingroom/order/modal/void.html", ctx, status=status
    )
...
def orderline_change_quantity(request, order_pk, line_pk):
    ...
    template = "tradingroom/order/modal/change_quantity.html"
    return TemplateResponse(request, template, ctx, status=status)
...
def orderline_cancel(request, order_pk, line_pk):
    ...
    return TemplateResponse(
        request, "tradingroom/order/modal/cancel_line.html", ctx, status=status
    )
...
def add_variant_to_order(request, order_pk):
    ...
    if form.is_valid():
        ...
        return redirect("tradingroom:order-details", order_pk=order_pk)
    elif form.errors:
        status = 400
    ctx = {"order": order, "form": form}
    template = "tradingroom/order/modal/add_variant_to_order.html"
    return TemplateResponse(request, template, ctx, status=status)
...
def order_address(request, order_pk, address_type):
    ...
    return TemplateResponse(request, "tradingroom/order/address_form.html", ctx)
...
def order_customer_edit(request, order_pk):
    ...
    ctx = {"order": order, "form": form}
    return TemplateResponse(
        request, "tradingroom/order/modal/edit_customer.html", ctx, status=status
    )
...
def order_customer_remove(request, order_pk):
    ...
    if form.is_valid():
        ...
        messages.success(request, msg)
        return redirect("tradingroom:order-details", order_pk=order_pk)
    return redirect("tradingroom:order-customer-edit", order_pk=order.pk)
...
def order_shipping_edit(request, order_pk):
    ...
    ctx = {"order": order, "form": form}
    return TemplateResponse(
        request, "tradingroom/order/modal/edit_shipping.html", ctx, status=status
    )
...
def order_shipping_remove(request, order_pk):
    ...
    if form.is_valid():
        ...
        messages.success(request, msg)
        return redirect("tradingroom:order-details", order_pk=order_pk)
    return redirect("tradingroom:order-shipping-edit", order_pk=order.pk)
...
def order_discount_edit(request, order_pk):
    ...
    ctx = {"order": order, "form": form}
    return TemplateResponse(
        request, "tradingroom/order/modal/edit_discount.html", ctx, status=status
    )
...
def order_voucher_edit(request, order_pk):
    ...
    ctx = {"order": order, "form": form}
    return TemplateResponse(
        request, "tradingroom/order/modal/edit_voucher.html", ctx, status=status
    )
...
def cancel_order(request, order_pk):
    ...
    ctx = {"form": form, "order": order}
    return TemplateResponse(
        request, "tradingroom/order/modal/cancel_order.html", ctx, status=status
    )
...
def order_voucher_remove(request, order_pk):
    ...
    if form.is_valid():
        ...
        with transaction.atomic():
            ...
            messages.success(request, msg)
        return redirect("tradingroom:order-details", order_pk=order.pk)
    return redirect("tradingroom:order-voucher-edit", order_pk=order.pk)
...
def mark_order_as_paid(request, order_pk):
    ...
    ctx = {"form": form, "order": order}
    return TemplateResponse(
        request, "tradingroom/order/modal/mark_as_paid.html", ctx, status=status
    )
...
def fulfill_order_lines(request, order_pk):
    ...
    template = "tradingroom/order/fulfillment.html"
    return TemplateResponse(request, template, ctx, status=status)
...
def cancel_fulfillment(request, order_pk, fulfillment_pk):
    ...
    return TemplateResponse(
        request, "tradingroom/order/modal/cancel_fulfillment.html", ctx, status=status
    )
...
def change_fulfillment_tracking(request, order_pk, fulfillment_pk):
    ...
    ctx = {"form": form, "order": order, "fulfillment": fulfillment}
    return TemplateResponse(
        request, "tradingroom/order/modal/fulfillment_tracking.html", ctx, status=status
    )
