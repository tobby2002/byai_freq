...
def sale_list(request):
    ...
    return TemplateResponse(request, "tradingroom/discount/sale/list.html", ctx)
...
def sale_add(request):
    ...
    if form.is_valid():
        ...
        return redirect("tradingroom:sale-update", pk=sale.pk)
    ctx = {"sale": sale, "form": form}
    return TemplateResponse(request, "tradingroom/discount/sale/form.html", ctx)
...
def sale_delete(request, pk):
    ...
    if request.method == "POST":
        ...
        messages.success(request, msg)
        return redirect("tradingroom:sale-list")
    ctx = {"sale": instance}
    return TemplateResponse(
        request, "tradingroom/discount/sale/modal/confirm_delete.html", ctx
    )
...
def voucher_list(request):
    ...
    return TemplateResponse(request, "tradingroom/discount/voucher/list.html", ctx)
...
def voucher_add(request):
    ...
    if voucher_form.is_valid():
        ...
        if form_type is None or form_type.is_valid():
            ...
            messages.success(request, msg)
            return redirect("tradingroom:voucher-list")
    ctx = {
        "voucher": voucher,
    ...
    return TemplateResponse(request, "tradingroom/discount/voucher/form.html", ctx)
...
def voucher_delete(request, pk):
    ...
    return TemplateResponse(
        request, "tradingroom/discount/voucher/modal/confirm_delete.html", ctx
    )
