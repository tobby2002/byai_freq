...
def collection_list(request):
    ...
    if request.method == "POST" and assign_homepage_col_form.is_valid():
        ...
        return redirect("tradingroom:collection-list")
    ...
    return TemplateResponse(request, "tradingroom/collection/list.html", ctx)
...
def collection_create(request):
    ...
    return TemplateResponse(request, "tradingroom/collection/detail.html", ctx)
...
def collection_update(request, pk=None):
    ...
    if form.is_valid():
        ...
        messages.success(request, msg)
        return redirect("tradingroom:collection-update", pk=collection.pk)
...
def collection_delete(request, pk=None):
    ...
    if request.method == "POST":
        ...
        messages.success(request, msg)
        if request.is_ajax():
            response = {"redirectUrl": reverse("tradingroom:collection-list")}
            return JsonResponse(response)
        return redirect("tradingroom:collection-list")
    ctx = {"collection": collection}
    return TemplateResponse(request, "tradingroom/collection/confirm_delete.html", ctx)
