...
def category_list(request):
    ...
    return TemplateResponse(request, "tradingroom/category/list.html", ctx)
...
def category_create(request, root_pk=None):
    ...
    if form.is_valid():
        ...
        if root_pk:
            return redirect("tradingroom:category-details", pk=root_pk)
        return redirect("tradingroom:category-list")
    ctx = {"category": category, "form": form, "path": path}
    return TemplateResponse(request, "tradingroom/category/form.html", ctx)
...
def category_edit(request, root_pk=None):
    ...
    template = "tradingroom/category/form.html"
...
def category_details(request, pk):
    ...
    return TemplateResponse(request, "tradingroom/category/detail.html", ctx)
...
def category_delete(request, pk):
    ...
    if request.method == "POST":
        ...
        if root_pk:
            if request.is_ajax():
                response = {
                    "redirectUrl": reverse(
                        "tradingroom:category-details", kwargs={"pk": root_pk}
                    )
                }
            ...
            if request.is_ajax():
                response = {"redirectUrl": reverse("tradingroom:category-list")}
                return JsonResponse(response)
            return redirect("tradingroom:category-list")
    ctx = {
        "category": category,
    ...
    return TemplateResponse(
        request, "tradingroom/category/modal/confirm_delete.html", ctx
    )
