...
MENU_SORT_BY_FIELDS = {"name": pgettext_lazy("Menu list sorting option", "Name")}
...
class MenuFilter(SortedFilterSet):
    ...
    def get_summary_message(self):
        ...
        return npgettext(
            "Number of matching records in the tradingroom menus list",
...
class MenuItemFilter(SortedFilterSet):
    ...
    def get_summary_message(self):
        counter = self.qs.count()
        return npgettext(
            "Number of matching records in the tradingroom menu items list",
